...
public class SwaggerConfig {
	...
	public static final String TAG_APPOINTMENT_OPERATION = "Appointment management";

    @Bean
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.timesheetio.appointment"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo())
                .tags(new Tag(TAG_APPOINTMENT_OPERATION, "Set of operations used to manage the registration of appointment to sheet."))
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("Timesheet.io Appointment")
            .description("Responsible for managing appointment on timesheet.io")
            .license("MIT")
